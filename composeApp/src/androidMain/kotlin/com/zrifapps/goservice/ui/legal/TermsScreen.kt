...
private val SECTIONS = listOf(
    "1. Penerimaan Syarat" to "Dengan mengunduh dan menggunakan aplikasi GoService (\"Aplikasi\"), kamu setuju untuk terikat oleh syarat dan ketentuan berikut. Jika kamu tidak setuju, mohon tidak menggunakan Aplikasi.",
    "2. Penggunaan Aplikasi" to "GoService adalah alat bantu untuk mencatat servis kendaraan, melacak komponen yang dipantau, dan mengingatkan jadwal servis. Fitur utama yang tersedia saat ini:\n" +
    ...
    "7. Hak Kekayaan Intelektual" to "Logo, desain, dan kode aplikasi adalah milik pengembang GoService. Konten yang kamu masukkan (data kendaraan, catatan) tetap milikmu.",
