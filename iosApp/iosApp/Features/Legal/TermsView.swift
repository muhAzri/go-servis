...
private let sections: [(String, String)] = [
    ...
    ("2. Penggunaan Aplikasi",
     "ServisGo adalah alat bantu untuk mencatat servis kendaraan, melacak komponen yang dipantau, dan mengingatkan jadwal servis. Fitur utama yang tersedia saat ini:\n" +
    ...
    ("5. Data Lokal & Tanggung Jawab Backup",
     ...
     "Sangat disarankan untuk menggunakan fitur Ekspor CSV secara berkala dan menyimpan file hasil ekspor di lokasi terpisah yang kamu kendalikan (mis. iCloud Drive atau cloud drive pribadi lainnya)."),
    ("6. Backup, Ekspor, dan Impor Data",
     "Fitur Ekspor menghasilkan satu file CSV yang berisi data Aplikasi yang kamu pilih. Setelah file keluar dari Aplikasi via dialog share/save sistem, kamu sepenuhnya bertanggung jawab atas tempat ia disimpan dan kepada siapa ia dibagikan — file dapat memuat informasi yang bisa mengidentifikasi kendaraanmu.\n\n" +
    ...
    ("7. Hak Kekayaan Intelektual", "Logo, desain, dan kode aplikasi adalah milik pengembang ServisGo. Konten yang kamu masukkan (data kendaraan, catatan) tetap milikmu."),
    ("8. Pembatasan Tanggung Jawab", "Kami tidak bertanggung jawab atas kerugian, langsung maupun tidak langsung, yang timbul dari: kegagalan komponen kendaraan, kelupaan jadwal servis, ketidakakuratan data yang kamu masukkan, kehilangan data lokal, atau kebocoran data yang terjadi setelah kamu mengekspor file backup ke luar perangkat."),
    ("9. Penghentian Layanan", "Kami berhak menghentikan atau memodifikasi layanan kapan saja dengan pemberitahuan yang wajar. Karena tidak ada data Aplikasi yang kami simpan di server, penghentian layanan tidak memengaruhi data lokal yang ada di perangkatmu."),
    ("10. Hukum yang Berlaku", "Syarat ini diatur oleh hukum Republik Indonesia."),
    ("11. Kontak", "muhammad.azri.f.s@gmail.com"),
]
